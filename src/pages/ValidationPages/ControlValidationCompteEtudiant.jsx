...
export default function ControlValidationCompteEtudiant() {
   ...
   // Redirige automatiquement vers le dashboard si le compte est valide
   useEffect(() => {
      if (!isLoading && !error && data) {
         if (data.openDashboard || data.confirmation === 1) {
            navigate("/dashboard");
         }
      }
                     ...
                     <>
                        <div>
                           ...
                           <span style={{ fontSize: 13 }}>
                              ...
                              dossiers <span style={{ color: "red", fontSize: 14 }}>spam</span> de votre boite mail...
                           </span>
                        </div>
                     </>
                  ) : (
